...
public class anketenAdapter extends RecyclerView.Adapter<anketenAdapter.ViewHolder> {
...
// Пристап до сите views за податок се дефинира во view holder
    ...
    // конструктор
    public anketenAdapter(List<String> myList, int rowLayout, Context context) {
        this.myList = myList;
